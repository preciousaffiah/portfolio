              ...
              <PageAnimation>
                <div className="md:w-[30rem]">
                  ...
                  <p className="md:pb-0 pb-12 text-base">
                    ...
                    innovative startup ventures meaning i'm not  <span className="text-xl font-semibold pb-3">New</span>{" "} to this, i'm  <span className="text-xl font-semibold pb-3">True</span>{" "} to this. Ready to{" "}
                ...
                <div className="md:w-[48%] w-full">
                  <PageAnimation>
                    <div className="bg-neutral-700">
                      <Link to="https://ikoafrica.com" target="_blank">
